...
var _appendQuery = require('append-query');var _appendQuery2 = _interopRequireDefault(_appendQuery);
var _axios = require('axios');var _axios2 = _interopRequireDefault(_axios);
var _debug = require('debug');var _debug2 = _interopRequireDefault(_debug);
var _lodash = require('lodash.get');var _lodash2 = _interopRequireDefault(_lodash);
var _invariant = require('invariant');var _invariant2 = _interopRequireDefault(_invariant);
var _isPlainObject = require('is-plain-object');var _isPlainObject2 = _interopRequireDefault(_isPlainObject);
var _lodash3 = require('lodash.omit');var _lodash4 = _interopRequireDefault(_lodash3);
var _urlJoin = require('url-join');var _urlJoin2 = _interopRequireDefault(_urlJoin);
...
function handleError(err) {
  if (err.response && err.response.data) {
    const error = (0, _lodash2.default)(err, 'response.data.error', {});
...
const debugRequest = (0, _debug2.default)('messaging-api-messenger');
...
class MessengerClient {
  ...
  version = '3.0')
  {
    ...
    if (!skipAppSecretProof) {
      ...
      this._axios.interceptors.request.use(config => {
        ...
        const accessToken = (0, _lodash2.default)(
        urlParts,
        'query.access_token',
        this._accessToken);
        ...
        config.url = (0, _appendQuery2.default)(config.url, {
    ...
    this._axios.interceptors.request.use(config => {
      this._onRequest({
        ...
        (0, _lodash4.default)(config.headers, [
        'common',
        'get',
        'post',
        'put',
  ...
  debugToken({
    access_token: customAccessToken } =
  {}) {
    (0, _invariant2.default)(this._appId, 'App ID is required to debug token');
    (0, _invariant2.default)(this._appSecret, 'App Secret is required to debug token');
...

  {
    ...
    (0, _invariant2.default)(appId, 'App ID is required to create subscription');
    (0, _invariant2.default)(
  ...
  options = {})
  {
    ...
    (0, _lodash4.default)(options, 'quick_replies')));
  ...
  options = {})
  {
    ...
    if (typeof attachment === 'string') {
      ...
      form.append('filedata', attachment, (0, _lodash4.default)(options, ['is_reusable']));
  ...
  {}) {var _this = this;return _asyncToGenerator(function* () {
      ...
      do {
        ...
        var _ref4 = yield _this.getPersonas(cursor, {
          access_token: customAccessToken });const data = _ref4.data,paging = _ref4.paging;
